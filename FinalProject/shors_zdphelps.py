...
####################################################################################################
# Reference Code for final project
# Zane Phelps
# Code runs on comand line
# Compile by running phython 3 shors_zdphelps.py #number#
# where the number is the number you want to factor
####################################################################################################
